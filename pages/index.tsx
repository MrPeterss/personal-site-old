...
const Home: NextPage = () => {
    ...
    if (isUpright) {
        return (
            <div className="min-h-screen w-full items-center justify-center bg-stone-900" suppressHydrationWarning >
                <Head>
                ...
                <main>
                    ...
                    {/* content */}
                    <div className="flex flex-col w-full gap-6 px-4 pt-20 min-h-screen" ref={aboutRef}>
                        ...
                        <motion.div className="grow-[2] self-center flex flex-col"
                            ...
                            <h3 className="font-serif text-cyan-400 text-xl">Cornell University Information Science Student and Freelance Developer</h3>
                    ...
                    <div className="flex flex-col w-full gap-6 px-10 py-8 bg-stone-800 min-h-screen" ref={projectRef}>
                        <h1 className="font-serif text-white text-6xl text-left font-white pt-24">Personal Projects</h1>
                        <div className="flex w-full gap-6 px-10 py-6 bg-stone-800 overflow-auto no-scrollbar grow-[4]">
                            <div className="flex w-full gap-12 overflow-auto">
                                <div className="bg-stone-900 rounded-2xl w-[60px]">hello</div>
                                <div className="bg-stone-900 rounded-2xl w-96">hello</div>
                                <div className="bg-stone-900 rounded-2xl w-96">hello</div>
                                <div className="bg-stone-900 rounded-2xl w-96">hello</div>
                            </div>
                        </div>
                    </div>
                    <div className="flex w-full gap-6 px-10 py-16 bg- min-h-screen" ref={resumeRef}>
                        
                    </div>
                    <div className="flex w-full gap-6 px-10 py-16 bg-stone-800 min-h-screen" ref={contactRef}>
